...
const Home = (props) => {
    ...
    const { data: latestArticle } = useSWR(`${process.env.API_URI}article/`, fetcherGet, { initialData: props.latest })
...
export async function getStaticProps() {
    const latest = await fetcherGet(`${process.env.API_URI}news/api`)
